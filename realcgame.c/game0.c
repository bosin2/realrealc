...
void event3() {
    ...
    print_slow3("당신의 소지금이 %dG가 되었습니다.\n",30, replace,1);
    printf("\n");
...
void event8() {
    ...
    printf("\n");
    int replace[] = { totalHealth };
    print_slow3("진이 모두 빠져버린 당신은 망신창이가 되었습니다. 체력을 20잃어 % 가 되었습니다.\n",30, replace,1);
    Sleep(1000);
...
Special specials[] = {
    ...
    {"동앗줄의길태숙",specials5 },
    {"쌍동앗줄날개성한울",specials6 },
    {"각성한녹말이쑤시개의김석규",specials7 },
    {"각성한사슬낫의박소영",specials8 },
